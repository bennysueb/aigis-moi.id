                            ...
                            <div wire:key="field-{{ $field['name'] }}">
                                ...
                                <div x-data="{
                                                ...
                                                addLogo(catIndex) {
                                                    ...
                                                    // UPDATE: Menambahkan field 'desc' untuk narasi
                                                    this.items[catIndex].logos.push({ url: '', name: '', desc: '', link: '' }); 
                                                },
                                    ...
                                    <template x-for="(category, catIndex) in items" :key="catIndex">
                                        <div class="bg-white border border-gray-200 rounded p-3 mb-3 shadow-sm">
                                            ...
                                            <div class="bg-gray-50 p-3 rounded border border-gray-100">
                                                <label class="block text-xs font-bold text-gray-500 mb-2">List Items (Berita/Foto/Sponsor)</label>
                                                    ...
                                                    <div class="relative bg-white border border-gray-200 p-3 rounded mb-3 shadow-sm">
                                                        ...
                                                        <div class="grid grid-cols-1 gap-3">
                                                            ...
                                                            <div class="grid grid-cols-2 gap-3">
                                                                <div>
                                                                    <label class="block text-[10px] text-gray-400 mb-1">Image / Thumbnail URL</label>
                                                                    <input type="text" x-model="category.logos[logoIndex].url" class="block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" placeholder="https://...">
                                                                </div>
                                                                <div>
                                                                    <label class="block text-[10px] text-gray-400 mb-1">Link Target (URL)</label>
                                                            ...
                                                            <div>
                                                                <label class="block text-[10px] text-gray-400 mb-1">Judul / Nama</label>
                                                                <input type="text" x-model="category.logos[logoIndex].name" class="block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" placeholder="Judul Berita / Nama Perusahaan">
                                                            </div>

                                                            <div>
                                                                <label class="block text-[10px] text-gray-400 mb-1">Deskripsi / Narasi Singkat</label>
                                                                <textarea x-model="category.logos[logoIndex].desc" rows="2" class="block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" placeholder="Tulis ringkasan berita atau keterangan di sini..."></textarea>
                                                            </div>
