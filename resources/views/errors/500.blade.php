        ...
        <div class="min-h-[60vh] flex items-center justify-center p-4">
            <div class="bg-white p-8 rounded-2xl shadow-xl w-full max-w-md">
                <div class="flex flex-col md:flex-row items-center">
                    {{-- Ikon --}}
                    <div class="flex-shrink-0 flex items-center justify-center h-20 w-20 rounded-full bg-orange-100">
                        <i class="fas fa-cogs text-4xl text-orange-600"></i>
                    </div>

                    {{-- Teks --}}
                    <div class="mt-6 md:mt-0 md:ml-6 text-center md:text-left">
                        <h2 class="text-sm font-semibold text-orange-600 tracking-wide uppercase">Error 500</h2>
                        <h3 class="mt-2 text-2xl font-bold text-gray-900 tracking-tight">Server Error</h3>
